...
DB_NAME = "users.db"
# Window configuration - Landscape untuk Android
# Saat di Android, orientasi akan ditentukan oleh buildozer.spec
# Untuk development di PC, gunakan landscape aspect ratio
if sys.platform != 'android':
    Window.size = (1920, 1080)  # Landscape ratio untuk testing di PC
# Untuk Android, jangan set size agar mengikuti device resolution
